...
<body class="container mt-5">
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <?php
                $archivo = basename($solicitud['archivo_reintegro']); // elimina cualquier path previo
                $archivo_url = 'uploads_reintegros/' . urlencode($archivo);
                ?>
                <td><a href="<?= $archivo_url ?>" target="_blank">Ver Archivo</a></td>
        </tr>
        <tr>
