...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['crear_usuario'])) {
    ...
    $monto_aprobacion = isset($_POST['monto_aprobacion'])
        ? str_replace(['.', ','], ['', '.'], $_POST['monto_aprobacion'])
        : '0';
...
<head>
    ...
    <!-- DataTables 1.13 + Bootstrap 5 -->
    <link rel="stylesheet" href="https://cdn.datatables.net/1.13.8/css/dataTables.bootstrap5.min.css">

    <!-- Botones de exportación DataTables -->
    <link rel="stylesheet" href="https://cdn.datatables.net/buttons/2.4.2/css/buttons.bootstrap5.min.css">

    <!-- Bootstrap-Select (select con búsqueda tipo "select2") -->
        ...
        <div class="card-body">
            <form method="post" class="row g-3">
                ...
                <div class="col-md-3">
                    ...
                    <!-- Bootstrap-Select: búsqueda al tipear -->
                    <select name="rol"
                        ...
                        foreach ($roles as $rolOpt):
                            $sel = ($rolSel === $rolOpt) ? 'selected' : '';
                        ?>
                            <option value="<?= htmlspecialchars($rolOpt) ?>" <?= $sel ?>>
                                <?= htmlspecialchars($rolOpt) ?>
                            </option>
                        <?php endforeach; ?>
                    </select>
                </div>
...
$(document).ready(function () {
    // Inicializar Bootstrap-Select (select con búsqueda)
