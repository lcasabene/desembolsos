...
require_once 'scripts/form_process.php';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $pdo->prepare("INSERT INTO solicitudes (usuario_id, fecha_solicitud, monto, fecha_disponibilidad, modalidad, alias_cbu, observaciones, departamento_id) 
                           VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
    $result = $stmt->execute([
        $usuario_id,
        $fecha_solicitud,
    ...
    if ($result) {
        ...
        $form = array(
            ...
            'email' => array(
                ...
                'to' => 'lcasabene@gmail.com',
                'to' => 'informes@jesusmirefugio.org, arielcasabene@gmail.com',
                'Monto' => $monto,
                'alias_cbu' => $alias_cbu
...
<body class="container py-5">
    ...
    <form method="POST">
        ...
        <div id="datosTransferencia" style="display: none;">
            <div class="mb-3">
                <label for="alias_cbu" class="form-label">CBU</label>
