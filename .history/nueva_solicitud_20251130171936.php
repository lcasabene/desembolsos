...
$mail = new PHPMailer(true);
        ...
        try {
            $mail->isSMTP();
                $mail->Host = 'mail.jesusmirefugio.org';
                $mail->SMTPAuth = true;
                $mail->Username = 'informes@jesusmirefugio.org';
                $mail->Password = 'Vict2025!'; // poné la contraseña real del correo
                $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;
                $mail->Port = 465;

            $mail->setFrom('informes@jesusmirefugio.org', 'Sistema de Solicitudes');
