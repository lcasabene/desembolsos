...
if (function_exists('headers_seguridad')) {
    headers_seguridad();
}
...
function generar_token_csrf_simple() {
...
function verificar_token_csrf_simple($token) {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    // Verificar token CSRF
    if (!isset($_POST['csrf_token']) || !verificar_token_csrf_simple($_POST['csrf_token'])) {
            ...
            <div class="card login-card">
                <div class="card-body p-4">
                    ...
                    <form method="POST" action="">
                        <input type="hidden" name="csrf_token" value="<?= generar_token_csrf_simple() ?>">
